...
use wasmparser::{self, FromReader, Operator, SectionReader, Type};
use wasmparser::{SectionLimited, SectionWithLimitedItems};
...
fn iterate_with_size<'a, T: FromReader<'a>>(
    s: &'a mut SectionLimited<'a, T>,
